                  ...
                  <div class="row">
                    ...
                    <div class="col-8">
                      <div class="card-tools d-inline float-right">
                        @if(auth::user()->type == "Admin" or or auth::user()->position == "MANAGER")
                          ...
                          @elseif(or auth::user()->position == "MANAGER")
                            @if($data->StatusApp_car != 'อนุมัติ')
                              <button type="submit" class="delete-modal btn btn-success btn-sm">
                                <i class="fas fa-save"></i> Update
                              </button>
                              ...
                              <div class="col-md-8">
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    @if(auth::user()->type == "Admin" or or auth::user()->position == "MANAGER" or auth::user()->position == "AUDIT")
