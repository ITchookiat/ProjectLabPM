    ...
    <div class="col-md-12 table-responsive">
      <div class="card">
        <div class="card-body">
          ...
          <div class="row mb-0">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">LAB PLoan-Micro</h1>
            </div>
            <div class="col-sm-6">
          ...
          <div align="center">
            <a href="{{ route('Analysis',1) }}"><img class="img-responsive" src="{{ asset('dist/img/leasing03.png') }}" alt="User Image" style = "width: 43%"></a>
          </div>
