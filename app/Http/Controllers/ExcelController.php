...
class ExcelController extends Controller
{
    ...
    public function excel(Request $request)
    {
      ...
      elseif($request->type == 3){  //รายงานสินเชื่อ
        ...
        $data_array[] = array('ลำดับ','สาขา','วันที่โอน','สถานะ','ยี่ห้อ','รุ่น','ทะเบียนเดิม','ทะเบียนใหม่','เลขสัญญา','ปี','ยอดจัด','ค่าดำเนินการ','รวมค่าดำเนินการ','ชำระต่องวด','กำไรดอกเบี้ย','ดอกเบี้ย/เดือน','งวดผ่อน(เดือน)','พรบ.','ยอดปิดบัญชี','ซื้อประกัน', '%ยอดจัด',
