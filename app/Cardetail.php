...
class Cardetail extends Model
{
  ...
  protected $fillable = ['Buyercar_id','Brand_car','Typecardetails','Groupyear_car','Year_car','Colour_car','IDTank_car','IDMachine_car','License_car','Nowlicense_car','Mile_car','Midprice_car','Model_car',
