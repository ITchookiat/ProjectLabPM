...
class Buyer extends Model
{
  ...
  protected $fillable = ['Contract_buyer','Flag','Type_Con','Date_Due','Name_buyer','last_buyer','Nick_buyer','Status_buyer','Phone_buyer','Phone2_buyer',
                        ...
                        'securities_buyer','deednumber_buyer','area_buyer','BeforeIncome_buyer','AfterIncome_buyer','Gradebuyer_car','Objective_car','Walkin_id','SendUse_Walkin','Memo_buyer','Memo_broker'];
